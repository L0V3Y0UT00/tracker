...
def get_phone_number_details(phone_number_str):
    try:
        parsed_number = phonenumbers.parse(phone_number_str, "PK")  # Set default region to Pakistan
...
if __name__ == "__main__":
    ...
    phone_number_input = input(f"\n\n{RED}Enter a phone number (e.g., +921234567890): {RESET}")
    ...
    if phone_details and phone_details["valid"]:
        ...
        print(f"\n{RED}  Invalid phone number. Please ensure it includes the country code (e.g., +92...).{RESET}")
